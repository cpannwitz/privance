...
import type { CategoryWithTransactions, MonthlyAggregations } from '../../../types/types'
    ...
    Object.keys(monthlyData.years).forEach(year => {
      ...
      Object.keys(monthlyData.years[year].months).forEach(month => {
        ...
        monthlyData.years[year].months[month].totalMonthPlusPercentage =
          (Math.abs(totalMonthPlus) / (Math.abs(totalMonthPlus) + Math.abs(totalMonthMinus))) * 100
        monthlyData.years[year].months[month].totalMonthMinusPercentage =
          (Math.abs(totalMonthMinus) / (Math.abs(totalMonthPlus) + Math.abs(totalMonthMinus))) * 100
